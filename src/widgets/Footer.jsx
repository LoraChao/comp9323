...
function Footer() {
  return (
    <footer className="grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5">
      ...
      {[1].map((v) => (
        <nav key={v} className="grid gap-2 text-center">
          <p className="text-lg text-black">Github Is Savior</p>
          <a href="">phone number: +1234567</a>
          <a href="">email address: abs@unsw.edu.au</a>
        </nav>
      ))}
