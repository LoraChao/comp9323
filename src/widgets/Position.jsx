...
constructor(props) {
  ...
  this.state = {
    flag: true,
    position_data:[{CompanyName: '', Position: '', Contact: ''},
    {CompanyName: '', Position: '', Contact: ''},
    {CompanyName: '', Position: '', Contact: ''},
    {CompanyName: '', Position: '', Contact: ''},
    {CompanyName: '', Position: '', Contact: ''},
  ]}
        ...
        <div>
          ...
          <ul className="grid gap-3">
            {[0, 1, 2, 3, 4].map((v) => (
              ...
              >
                <a href='#' className="text-lg font-bold">{this.state.position_data[v]["Position"]}</a>
                <div className="flex justify-between relative">
                  <p className="text-lg leading-7 mt-1">
                   {this.state.position_data[v]["CompanyName"]}
                  </p>
                  <p class="mt-2 text-gray-500">{this.state.position_data[v]["Contact"]}</p>
                  <svg
                    width="38"
                    height="38"
                    viewBox="0 0 38 38"
